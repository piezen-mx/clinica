 ...
 * `app/dashboard/empleados/[id]/componentes/EmployeeTabs.tsx`. Solo "General" está
 * habilitada en este spec; Clientes, Productos, Facturas y Personalización se
 * agregan a este mismo arreglo en los specs 29-31.
 */
