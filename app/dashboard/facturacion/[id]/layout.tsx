...
import ModeSwitch from "./componentes/ModeSwitch";
import LiveModeBanner from "./componentes/LiveModeBanner";
...
export default async function OrganizationDetailLayout({ params, children }: Props) {
  ...
  const { organization, isLive } = result.data;

  return (
    <div className="flex flex-col gap-6">
      {/* Renderizada aquí, en el layout, para que aparezca en las cinco pestañas
          de la organización (spec 30) — no solo en la de Facturas. */}
      <LiveModeBanner isLive={isLive} />
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <ModeSwitch orgId={id} initialIsLive={isLive} />
      </div>
